def main():
    try:
        ...
        for index, flower in enumerate(flowers, start=1):  # Using enumerate to get both index and flower
        ...
        try:
            ...
            if number in range(1, len(flowers)+1):  # Check if number is within valid range
